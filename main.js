...
// ------------------------------------------------------------------------------------------------
/*
# Horizon example requests!

`text/event-stream` is called the MIME type of the request.
MIME types have a syntax with template `type/subtype`

curl --verbose "https://horizon.stellar.org/order_book/trades"
curl --verbose "https://horizon.stellar.org/order_book/trades?selling_asset_type=native&buying_asset_type=credit_alphanum4&buying_asset_code=CNY&buying_asset_issuer=GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX"
curl --verbose "https://horizon.stellar.org/order_book?selling_asset_type=native&buying_asset_type=credit_alphanum4&buying_asset_code=CNY&buying_asset_issuer=GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX"

curl --verbose --header "Accept: text/event-stream" "https://horizon.stellar.org/ledgers?cursor=14096598&order=asc&limit=1"
curl --verbose --header "Accept: text/event-stream" "https://horizon.stellar.org/order_book?selling_asset_type=native&buying_asset_type=credit_alphanum4&buying_asset_code=CNY&buying_asset_issuer=GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX"
curl --verbose --header "Accept: text/event-stream" "https://horizon.stellar.org/order_book/trades?selling_asset_type=native&buying_asset_type=credit_alphanum4&buying_asset_code=CNY&buying_asset_issuer=GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX"
curl --verbose --header "Accept: text/event-stream" "https://horizon.stellar.org/accounts/GAOXVBKHGKH3UNAK4EIG3XVAWMA4B7Y3LF42EMIKJINVMLTNXYGHUQWM"
...
https://horizon.stellar.org/accounts/GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX
https://horizon.stellar.org/accounts/GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX/transactions
https://horizon.stellar.org/accounts/GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX/operations
https://horizon.stellar.org/accounts/GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX/effects
https://horizon.stellar.org/accounts/GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX/payments
https://horizon.stellar.org/accounts/GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX/offers
https://horizon.stellar.org/accounts/GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX/trades

https://horizon.stellar.org/ledgers?order=desc&limit=2
https://horizon.stellar.org/ledgers/14044862
https://horizon.stellar.org/ledgers/14044862/transactions
https://horizon.stellar.org/ledgers/14044862/operations
https://horizon.stellar.org/ledgers/14044862/effects
https://horizon.stellar.org/ledgers/14044862/payments

https://horizon.stellar.org/transactions?order=desc&limit=2

https://horizon.stellar.org/operations?order=desc&limit=2

https://horizon.stellar.org/effects?order=desc&limit=2

https://horizon.stellar.org/payments?order=desc&limit=2

https://horizon.stellar.org/order_book/trades?order=desc&limit=2
https://horizon.stellar.org/order_book/trades?cursor=60662388671651841&order=desc&limit=2

https://horizon.stellar.org/order_book?selling_asset_type=native&buying_asset_type=credit_alphanum4&buying_asset_code=CNY&buying_asset_issuer=GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX

https://horizon.stellar.org/order_book/trades?selling_asset_type=native&selling_asset_code={selling_asset_code}&selling_asset_issuer={selling_asset_issuer}&buying_asset_type={buying_asset_type}&buying_asset_code={buying_asset_code}&buying_asset_issuer={buying_asset_issuer}


# Anchors

GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX  CNY ripplefox.com
GBVAOIACNSB7OVUXJYC5UE2D4YK2F7A24T7EE5YOMN4CE6GCHUTOUQXM  JPY vcbear.net 
GA7FCCMTTSUIC37PODEL6EOOSPDRILP6OQI5FWCWDDVDBLJV72W6RINZ  XRP vcbear.net
GBUQWP3BOUZX34TOND2QV7QQ7K7VJTG6VSE7WMLBTMDJLLAW7YKGU6EP  PHP coins.asia
GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH  XEL naobtc.com
GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH  BTC naobtc.com
